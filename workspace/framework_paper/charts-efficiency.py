...
SCENARIOS = (
    {
        "name": "FP",
        "directory": "fp",
        "prefix": "gradient_fp_validation",
        "methods": ("pd", "hopa", "gdpa", "bf"),
        "labels": ("pd", "hopa", "gdpa", "bf"),
    },
    {
        "name": "MAP",
        "directory": "fp-mapping",
        "prefix": "gradient_fp_mapping_validation",
        "methods": ("gdpa-mapping", "gdpa", "pd"),
        "labels": ("gdpa+map", "gdpa", "pd"),
    },
    {
        "name": "EDF",
        "directory": "edf-local",
        "prefix": "gradient_edf_local_validation",
